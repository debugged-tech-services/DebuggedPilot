...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    if not Params().get_bool('ChryslerMangoLat'):
      ...
      ret.lateralTuning.pid.kpV = [0.022, 0.024, 0.027] # old values [0.02, 0.022, 0.025]

      ret.lateralTuning.pid.kiBP = [0., 15., 30.]
      ret.lateralTuning.pid.kiV = [0.0028, 0.003, 0.0032] # old values [0.0028, 0.003, 0.0032]

      ret.lateralTuning.pid.kf = 0.000040 # old values 0.00005 # stock was 0.00004 # full torque for 10 deg at 80mph means 0.00007818594
    ...
    ret.steerActuatorDelay = 0.01 # stock was 0.2 # TINY Adjustments! Lower delay "waits to turn longer", higher delay "starts the turn sooner"
    ret.steerRateCost = 0.68 #0.65 # stock was 0.55
