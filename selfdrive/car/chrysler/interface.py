...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    if not Params().get_bool('ChryslerMangoLat'):
      ...
      ret.lateralTuning.pid.kpV = [0.01, 0.015, 0.02] # stock values [0.05, 0.07, 0.075]

      ret.lateralTuning.pid.kiBP = [0., 30.]
      ret.lateralTuning.pid.kiV = [0.002, 0.003]

      ret.lateralTuning.pid.kf = 0.0000285  # stock was 0.00004 # full torque for 10 deg at 80mph means 0.00007818594
