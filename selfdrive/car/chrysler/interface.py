...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, disable_radar=False):
    ...
    if not Params().get_bool('ChryslerMangoLat'):
      ...
      ret.lateralTuning.pid.kpV = [0.014, 0.017, 0.018] # old values [0.013, 0.016, 0.022]

      ret.lateralTuning.pid.kiBP = [0., 15., 30.]
      ret.lateralTuning.pid.kiV = [0.0025, 0.0028, 0.003] # old values [0.0025, 0.0028, 0.003]

      ret.lateralTuning.pid.kf = 0.00004 # old values 0.00005 # stock was 0.00004 # full torque for 10 deg at 80mph means 0.00007818594
