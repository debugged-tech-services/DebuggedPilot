...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=None, has_relay=False, car_fw=None):
    ...
    ret.steerActuatorDelay = 10.0
    #ret.steerRateCost = 1.0
    ret.steerLimitTimer = 0.8

    ret.lateralTuning.init('indi')
    ret.lateralTuning.indi.innerLoopGain = 40.0
    ret.lateralTuning.indi.outerLoopGainBP = [0, 5, 10] #BP is the vehicle speed in m/sec
    ret.lateralTuning.indi.outerLoopGainV = [60.0, 1.5, 2.0] #V is the gain value to use when at that speed
